  ...
  return (
	...
	<div className="container flex justify-between h-16 mx-auto">
		<ul className="items-stretch hidden space-x-3 lg:flex">
			<li className=" flex items-center px-4 -mb-1   dark:border-transparent text-black  ">
				<NavLink rel="noopener noreferrer" to="/"  style={({ isActive, isPending }) => {
    return {
      ...
      color: isPending ? "red" : "black",
			...
			<li className="flex items-center px-4 -mb-1 dark:border-transparent text-black  ">
				<NavLink rel="noopener noreferrer" to="/destination"  style={({ isActive, isPending }) => {
    return {
      fontWeight: isActive ? "bold" : "",
      color: isPending ? "red" : "black",
    };
			...
			<li className="flex items-center px-4 -mb-1 dark:border-transparent text-black  ">
				<NavLink rel="noopener noreferrer"  style={({ isActive, isPending }) => {
    return {
      fontWeight: isActive ? "bold" : "",
      color: isPending ? "red" : "black",
    };
			...
			<li className="flex items-center px-4 -mb-1dark:border-transparent text-black 0">
				<NavLink rel="noopener noreferrer" to="/contact"   style={({ isActive, isPending }) => {
    return {
      fontWeight: isActive ? "bold" : "",
      color: isPending ? "red" : "black",
    };
		...
		<div className="flex items-center md:space-x-4">
			...
			<button type="button" className="hidden px-6 py-2 font-semibold rounded lg:block bg-[#F9A51A] dark:text-black">Log in</button>
		</div>
...
export default Navbar;<header className="p-4 dark:bg-gray-800 dark:text-gray-100">
	<div className="container flex justify-between h-16 mx-auto">
		<ul className="items-stretch hidden space-x-3 lg:flex">
			<li className="flex">
